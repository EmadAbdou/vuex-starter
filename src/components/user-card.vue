<template>
  <div class="inner-div">
    ...
    <div class="front__text">
      ...
      <p class="front__text-para">Age: {{ user.age }}</p>
      ...
      <router-link v-else :to="`/users/${user.id}`" class="full-details-link"
...
export default {
  ...
  computed: {
    ...
    userImageUrl() {
      return `https://avatars.abstractapi.com/v1/?api_key=2f7e3db94baf4e9d9f7a1ab556f112fa&name=${this.userName}`;
    },
  },
};
</script>
...
.front__bkg-photo {
  position: relative;
  height: 150px;
  background-image: url("https://images.unsplash.com/photo-1511207538754-e8555f2bc187?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=88672068827eaeeab540f584b883cc66&auto=format&fit=crop&w=1164&q=80");
